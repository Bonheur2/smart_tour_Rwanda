...
let availablekeywords=["Kigali Genocide Memorial", "Kinigi Village", "Akagera National Park", "Gishwati Forest",
         "Nyanza Royal Palace","Nyungwe National Park" ,"Bigogwe Breast","Huye National Museum","Kigali Art Museum",
         "Lake Kivu", "Ibyiwacu cutural Village","Bugesera National Airport", "Volcanoes National Park"];
        ...
        // going to
        let availablekeywords2=["Kigali Genocide Memorial", "Kinigi Village", "Akagera National Park", "Gishwati Forest",
        "Nyanza Royal Palace","Nyungwe National Park" ,"Bigogwe Breast","Huye National Museum","Kigali Art Museum",
        "Lake Kivu", "Ibyiwacu cutural Village","Bugesera National Airport", "Volcanoes National Park"];
